/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4b1a014e9fc237f8b4a2b0e3dd15dea2)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FACEIT_COOKIE">> {}
}
